...
class ClientIndexButtonVisibilityTest extends AbstractTestCase
{
    ...
    #[Test]
    public function it_shows_new_client_heading_button_when_user_has_client_create_permission(): void
    {
    ...
    #[Test]
    public function it_does_not_show_new_client_heading_button_when_user_lacks_client_create_permission(): void
    {
