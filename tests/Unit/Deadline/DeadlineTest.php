...
class DeadlineTest extends AbstractTestCase
{
    ...
    #[Test]
    public function it_returns_zero_days_until_deadline_when_deadline_is_null()
    {
        /** Arrange */
        // The getDaysUntilDeadlineAttribute() was updated in this PR to return 0 when deadline is null,
        // rather than calling diffInDays() on null which would throw an error.
        $this->task->deadline = null;
        $this->task->save();
        ...
        /** Assert */
        $this->assertEquals(0, $leadDays, 'days_until_deadline should return 0 when deadline is null');
        $this->assertEquals(0, $taskDays, 'days_until_deadline should return 0 when deadline is null');
        $this->assertEquals(0, $projectDays, 'days_until_deadline should return 0 when deadline is null');
    }
