...
test.describe('Password and session UX', () => {
    test('forgot password page renders the reset link button', async ({ page }) => {
    ...
    test('login page exposes a remember me option', async ({ page }) => {
