        ...
        <div class="col-sm-8">
            <div class="tablet">
                <div class="tablet__body">
                    <form action="{{route('projects.update', $project->external_id)}}" method="POST">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" cols="50" rows="10" class="form-control">{{old('description', $project->description)}}</textarea>
                        </div>
                        <div class="form-group">
                            <a href="{{route('projects.show', $project->external_id)}}" class="btn btn-default">@lang('Cancel')</a>
