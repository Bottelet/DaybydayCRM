...
- Fixed two CI-only failures (Vite manifest missing, `.env.testing` overwritten by a workflow step) that only surfaced once the underlying MySQL database-creation step order was corrected.
